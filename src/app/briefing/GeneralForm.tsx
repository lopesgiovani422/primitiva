...
export default function Briefing() {
        ...
        if (isStepValid) {
            if (currentStep <= totalSteps) {
                ...
                if (currentStep === 1 && !hasStartedRef.current) {
                    ...
                    posthog.capture('briefing_started', {
                        form_type: 'general',
                        step: 1
                    });
                }
                ...
                posthog.capture('briefing_step_completed', {
                    form_type: 'general',
                    step: currentStep,
    ...
    const onSubmit = async (data: BriefingFormData) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                posthog.capture('briefing_submitted', {
                    form_type: 'general',
    ...
    return (
        <div className="font-display bg-[#0A0A0A] text-white h-dvh overflow-hidden flex flex-col selection:bg-white selection:text-black" onKeyDown={handleKeyDown}>
            {/* Progress Bar */}
            ...
            <div className="fixed top-8 right-8 z-50">
                <Link href="/contato" className="text-white/40 hover:text-white transition-colors text-xs font-mono uppercase tracking-widest flex items-center gap-2 group">
            ...
            <style jsx global>{`
                .input-text, input[type="text"], input[type="email"], input[type="tel"] { width: 100%; background: transparent; border: none; border-bottom: 2px solid rgba(255,255,255,0.1); padding-top: 1rem; padding-bottom: 1rem; padding-left: 0; font-size: 2rem; color: white; outline: none; transition: all 0.3s ease; font-weight: 300; border-radius: 0; }
                .input-text:focus, input[type="text"]:focus, input[type="email"]:focus, input[type="tel"]:focus { border-bottom-color: white; caret-color: white; outline: none !important; box-shadow: none !important; }
                .input-text::placeholder, input::placeholder { color: rgba(255,255,255,0.2); }
                ...
                .input-textarea:focus, textarea:focus { border-bottom-color: white; caret-color: white; outline: none !important; box-shadow: none !important; }
                .input-textarea::placeholder, textarea::placeholder { color: rgba(255,255,255,0.2); }
                
                @media (min-width: 768px) { 
                    .input-text, input[type="text"], input[type="email"], input[type="tel"] { font-size: 3rem; } 
                    .input-textarea, textarea { font-size: 2rem; }
                }
