...
export default function PedeCafePageContent() {
                ...
                <main className="relative flex flex-col w-full min-h-screen pt-16">
                    ...
                    <section className="md:border-b border-white/20 bg-neutral-900 relative overflow-hidden">
                        <div className="relative w-full group overflow-hidden reveal-img scroll-trigger">
                            <div className="flex md:hidden w-full aspect-[3/4] relative bg-neutral-900/50">
                                {/* @ts-ignore */}
                                <dotlottie-player id="lottie-cup-mobile-1" src="/assets/pedecafe/lottie/mobile/animation1.lottie"
                                    background="transparent" speed="1" className="w-full h-full block opacity-0 transition-opacity duration-500"
                                    style={{ pointerEvents: 'none', objectFit: 'cover' }}>
                                </dotlottie-player>
                            </div>

                            <div className="hidden md:block w-full aspect-video relative bg-neutral-900/50">
                                {/* @ts-ignore */}
                                <dotlottie-player id="lottie-cup-desktop-1" src="/assets/pedecafe/lottie/desktop/animation1.lottie"
                                    background="transparent" speed="1" className="w-full h-full block opacity-0 transition-opacity duration-500"
                                    style={{ pointerEvents: 'none', objectFit: 'cover' }}>
                                </dotlottie-player>
                            </div>
                    ...
                    <section className="md:border-b border-white/20 bg-background-dark relative overflow-hidden">
                        <div className="relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 items-end">
                                ...
                                <div className="relative w-full order-3 md:order-2 md:mt-0 scroll-trigger">
                                    <div className="flex md:hidden w-full aspect-[3/4] relative bg-neutral-900/50">
                                        {/* @ts-ignore */}
                                        <dotlottie-player id="lottie-cup-mobile-2" src="/assets/pedecafe/lottie/mobile/animation2.lottie"
                                            background="transparent" speed="1" className="w-full h-full block opacity-0 transition-opacity duration-500"
                                            style={{ pointerEvents: 'none', objectFit: 'cover' }}>
                                        </dotlottie-player>
                                    </div>
                                    ...
                                    <div className="hidden md:block w-full aspect-video relative bg-neutral-900/50">
                                        {/* @ts-ignore */}
                                        <dotlottie-player id="lottie-cup-desktop-2" src="/assets/pedecafe/lottie/desktop/animation2.lottie"
                                            background="transparent" speed="1" className="w-full h-full block opacity-0 transition-opacity duration-500"
                                            style={{ pointerEvents: 'none', objectFit: 'cover' }}>
                                        </dotlottie-player>
                                    </div>
